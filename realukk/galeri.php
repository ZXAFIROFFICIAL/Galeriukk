...
<body>
    ...
    <aside class="probootstrap-aside js-probootstrap-aside">
        ...
        <div class="probootstrap-overflow">
            <nav class="probootstrap-nav">
                <ul>
                    <li class="probootstrap-animate" data-animate-effect="fadeInLeft"><a href="index.php">Beranda</a></li>
                    <li class="probootstrap-animate active" data-animate-effect="fadeInLeft"><a href="galeri.php">Galeri</a></li>
    ...
    <main role="main" class="probootstrap-main js-probootstrap-main">
        <div class="probootstrap-bar">
            ...
            <div class="probootstrap-main-site-logo"><a href="galeri.php">GALERI</a></a></div>
        </div><br><br>
        <div>
            <div class="container">
                <form class="search-form" action="galeri.php">
